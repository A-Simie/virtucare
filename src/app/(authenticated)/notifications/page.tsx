      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button 
            ...
            className="rounded-2xl h-11 font-bold text-sm bg-white"
          >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <h4 className="font-bold text-[#0f172a] text-lg">{notif.title}</h4>
                          {!notif.read && (
                      ...
                      {!notif.read && (
                        <Button 
                          ...
                          className="text-xs font-bold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-xl"
                        >
                          Mark as read
                        </Button>
                      )}
